...
export class AdvancedSearchComponent implements OnInit {
  ...
  public sections: any[] = ['Arts', 'Automobiles', 'Autos', 'Blogs', 'Books', 'Booming', 'Business', 'Business Day', 'Corrections',
  ...
  public types: any[] = ['Addendum', 'An Analysis', 'An Appraisal', 'Article', 'Banner', 'Biography', 'Birth Notice', 'Blog', 'Brief',
